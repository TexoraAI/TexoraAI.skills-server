...
public interface StudentBatchAccessRepository
 ...
 // NEW — idempotency check for Kafka STUDENT_ASSIGNED replay (BatchAssignmentConsumer)
    boolean existsByBatchIdAndStudentEmail(Long batchId, String studentEmail);
}
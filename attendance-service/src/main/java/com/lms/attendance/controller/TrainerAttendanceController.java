...
//// Role gating now happens per-method below AND at the gateway (GatewaySecurityConfig),
//// since ADMIN/TENANT_ADMIN/SUPER_ADMIN also need to reach endpoints in this same controller.
...
//
//        // NEW — trusted organizationId, attached by JwtAuthenticationFilter; never from request body
...
//
//    // =======================================================
//    // NEW (e) — SUPER_ADMIN overview (orgless only)
//    // =======================================================
...
//
//    // =======================================================
//    // NEW (f) — SUPER_ADMIN batch detail (orgless only)
//    // =======================================================
//    @PreAuthorize("hasRole('SUPER_ADMIN')")
...
//    // type (history/download only): STUDENT (default) | SESSION
//    // =======================================================================================
//
//    // ---------------- TRAINER (own data) ----------------
//
...
//    }
//
//    // NEW (i) — trainer Excel download. type=SESSION for own session attendance,
...
//    // ---------------- ADMIN ----------------
//
//    // NEW (j) — admin attendance history, filtered by batch/trainer/student + date range
//    @PreAuthorize("hasRole('ADMIN')")
...
//    }
//
//    // NEW (k) — admin Excel download. type=SESSION for trainer-session rows,
...
//    // ---------------- SUPER ADMIN ----------------
//
//    // NEW (l) — super-admin attendance history, filtered by batch/trainer/student + date range, orgless only
//    @PreAuthorize("hasRole('SUPER_ADMIN')")
...
//    }
//
//    // NEW (m) — super-admin Excel download. type=SESSION for trainer-session rows,

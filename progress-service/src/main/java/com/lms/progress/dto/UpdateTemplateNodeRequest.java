...
public class UpdateTemplateNodeRequest {
    ...
    public UpdateTemplateNodeRequest() {
    }

    public UpdateTemplateNodeRequest(String title, String description, NodeType type, Double positionX,

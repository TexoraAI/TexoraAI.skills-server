...
//
//        // ← NEW: persist organizationId when admin creates a user
...
//        return repo.findUsersByRole(role).stream().map(this::mapToResponse).toList();
//    }
//
//    // ── GET BY ORG (NEW) ─────────────────────────────────────────────────────
//    /**
//     * Returns all users belonging to a given organization.
//     * Used by:
//     *   - SuperAdmin: GET /api/users/by-org/{orgId}
//     *   - TENANT_ADMIN: GET /api/users/my-org  (resolved via their own profile)
//     */
//    public List<UserResponse> getUsersByOrg(String organizationId) {
...
//
//    /**
//     * Returns users of a specific role within an org.
//     * e.g. role="STUDENT" or role="TRAINER"
//     */
//    public List<UserResponse> getUsersByOrgAndRole(String organizationId, String role) {
//        return repo.findByOrganizationIdAndRolesContaining(organizationId, role)
//                .stream()
//                .map(this::mapToResponse)
//                .toList();
//    }
...
//        r.setOrganizationId(u.getOrganizationId()); // ← NEW
//        return r;
//    }
//
//    // ────────────────────────────────────────────────────────────────────────
...
//        return trainerProfileRepo.findByUser_Email(email)
//                .map(this::mapToTrainerProfileResponse)
//                .orElseGet(TrainerProfileResponse::new);
//    }
//
...
//    // WHY: Trainer bio shown to students enrolled in their courses
//@Cacheable(value = "trainer:profile", key = "#email")
//    @Transactional(readOnly = true)
//    public TrainerProfileResponse getTrainerProfile(String email) {
//        return trainerProfileRepo.findByUser_Email(email)
//                .map(this::mapToTrainerProfileResponse)

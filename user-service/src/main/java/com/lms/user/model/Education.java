...
// WHY: Academic background shown on student resume and used in LMS enrollment eligibility checks
@Entity
@Table(name = "educations",
    indexes = {
        // WHY: Loaded with resume — same access pattern as WorkExperience
        @Index(name = "idx_educations_resume_id", columnList = "resume_id"),
        @Index(name = "idx_educations_resume_order", columnList = "resume_id, display_order")
    })
public class Education {

...
public enum RateLimitGroup {
    ...
    // Watch Now — public homepage carousel. Higher burst than GENERAL_API
    // because loading the section resolves several thumbnail/video URLs
    // (one request per unique story) in a short burst on page load.
    WATCH_NOW_API       (40,  150),

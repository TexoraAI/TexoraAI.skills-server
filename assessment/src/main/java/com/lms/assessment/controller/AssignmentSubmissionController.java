...
//    @PreAuthorize("hasRole('TRAINER')")
    ...
    @GetMapping("/usage/submit")
    public ResponseEntity<Map<String, Object>> getSubmitUsage(HttpServletRequest httpRequest) {
        return ResponseEntity.ok(assessmentUsageService.getUsageStatus(
                AssessmentUsageLimits.Action.ASSIGNMENT_SUBMIT, callerEmail(), orgId(httpRequest)));
    }

...
public class CodeFileController {
    ...
    public ResponseEntity<CodeFileDTO> save(
        ...
        return ResponseEntity.ok(codeFileService.save(req, orgId(httpRequest)));
    }
 ...
 // ADD this method
    @GetMapping("/usage/save")
    public ResponseEntity<Map<String, Object>> getSaveUsage(HttpServletRequest httpRequest) {
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        return ResponseEntity.ok(codeFileService.getSaveUsageStatus(auth.getName(), orgId(httpRequest)));
    }
}
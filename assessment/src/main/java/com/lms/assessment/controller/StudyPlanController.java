...
public class StudyPlanController {
    ...
    public ResponseEntity<?> createStudyPlan(
        ...
        } catch (AssessmentUsageLimitExceededException e) {
            throw e;
        } catch (Exception e) {
    ...
    // ══════════════════════════════════════════════
    // USAGE PREVIEW — read-only, not feature-gated
    // ══════════════════════════════════════════════
    @GetMapping("/usage/create")
    public ResponseEntity<Map<String, Object>> getCreateUsage(Authentication auth, HttpServletRequest httpRequest) {
        return ResponseEntity.ok(assessmentUsageService.getUsageStatus(
                AssessmentUsageLimits.Action.STUDY_PLAN_CREATE, auth.getName(), orgId(httpRequest)));
    }

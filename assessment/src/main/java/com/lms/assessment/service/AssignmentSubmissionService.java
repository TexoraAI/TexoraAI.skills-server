...
public class AssignmentSubmissionService {
    ...
    public SubmissionResponse submit(Long assignmentId,
        ...
        // ✅ Quota check — runs before the duplicate-submission check (check-then-act,
        // consistent with the placement pattern used across the other usage-gated services)
        assessmentUsageService.checkAndIncrement(
                AssessmentUsageLimits.Action.ASSIGNMENT_SUBMIT, studentEmail, organizationId);

...
public interface QuizRepository extends JpaRepository<Quiz, Long> {
    ...
    List<Quiz> findByOrganizationId(String organizationId);

    List<Quiz> findByOrganizationIdAndBatchId(String organizationId, Long batchId);

    Optional<Quiz> findByIdAndOrganizationId(Long id, String organizationId);

    boolean existsByIdAndOrganizationId(Long id, String organizationId);

    List<Quiz> findByOrganizationIdAndTrainerEmailAndActiveTrue(String organizationId, String trainerEmail);

    void deleteByOrganizationId(String organizationId);
    
    List<Quiz> findByOrganizationIdIsNull();
}
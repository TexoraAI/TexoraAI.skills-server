//
//
//// OPTIMIZATION: Added @Index annotations on all frequently queried columns.
//// These ensure Hibernate auto-creates indexes on startup.
//// Indexes cover: email (unique), organization_id, role, composite org+role,
//// composite role+approved, composite role+approved+email_verified.
//

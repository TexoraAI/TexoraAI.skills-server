...
public class SessionNotificationEvent {
    ...
    // ─────────────────────────────────────────────
    // NEW — optional, additive. Used by Phase 4 workflow-triggered
    // events (WORKFLOW_TRAINER_EMAIL / WORKFLOW_NOTIFY_STUDENTS) to carry
    // the actual AI-generated or custom message body. Left null by every
    // existing producer call site, so it has zero effect on existing
    // eventType handling in the consumer.
    // ─────────────────────────────────────────────
    private String workflowOutputText;
    ...
    public String getWorkflowOutputText() { return workflowOutputText; }
    public void setWorkflowOutputText(String workflowOutputText) { this.workflowOutputText = workflowOutputText; }
}